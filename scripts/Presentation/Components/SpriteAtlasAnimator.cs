...
public partial class SpriteAtlasAnimator : TextureRect
{
    ...
    [Export]
    public Texture2D AtlasSource { get; set; } = null!;
    ...
    [Export]
    public ShaderMaterial RedEyeMaterial { get; set; } = null!;
    ...
    {
        _atlas = AtlasSource;
        _frameDisplay = GetNode<TextureRect>("FrameDisplay");
    ...
    private void UpdateVisibleFrame(bool force)
    {
        ...
        _frameDisplay.Texture = new AtlasTexture
        {
            Atlas = _atlas,
            Region = new Rect2(
                frame * frameWidth,
        ...
        int rows)
    {
        ...
        using Image image = atlas.GetImage();
        if (image.IsEmpty())
        {
            return offsets;
        }
    ...
    private void ApplyRedEyeMaterial()
    {
        ...
        {
            _redEyeMaterial = (ShaderMaterial)RedEyeMaterial.Duplicate();
        }
