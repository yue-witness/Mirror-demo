...
public partial class ForcedChoiceTutorialOverlay : Control
{
    ...
    private static readonly Vector2 PointerSize = new(118.0f, 118.0f);
    ...
    private void RefreshLayout()
    {
        ...
        Vector2 pointerPosition = new(
            focusRect.GetCenter().X - PointerSize.X / 2.0f,
            Math.Max(86.0f, focusRect.Position.Y - PointerSize.Y + 8.0f));
        _pointer.Position = pointerPosition;
        _pointer.Size = PointerSize;
        _pointer.PivotOffset = PointerSize / 2.0f;
    }
